    ...
    function handleNotifToggle() {
        ...
        if (notifState.display === "none") {
            ...
            timer = setTimeout(() => {
                ...
                setTimeout(() => {
                    if (window.screen.width > 765) notifsRef.current.classList.add("notifs-ctn--active");
                    else notifsMobRef.current.classList.add("notifs-ctn--active");
                }, 15);
            }, 0);
        }
            ...
            if (window.screen.width > 765) notifsRef.current.classList.remove("notifs-ctn--active");
    ...
    function settingsToggle() {
        ...
        if (settingState.display === "none") {
            ...
            timer = setTimeout(() => {
                ...
                if (window.screen.width < 769) settingsToggleMobRef.current.classList.add("reg-log-btn-ctn__settings-toggle--rotate");
                else settingsToggleRef.current.classList.add("reg-log-btn-ctn__settings-toggle--rotate");

                setTimeout(() => {
                    if (window.screen.width < 769) settingsMobRef.current.classList.add("reg-log-btn-ctn__settings-ctn--show");
                    else settingsRef.current.classList.add("reg-log-btn-ctn__settings-ctn--show");
                }, 15);
            }, 0);
        }
            ...
            if (window.screen.width < 769) {
                settingsMobRef.current.classList.remove("reg-log-btn-ctn__settings-ctn--show");
                settingsToggleMobRef.current.classList.remove("reg-log-btn-ctn__settings-toggle--rotate");
            }
            else {
                settingsToggleRef.current.classList.remove("reg-log-btn-ctn__settings-toggle--rotate");
                settingsRef.current.classList.remove("reg-log-btn-ctn__settings-ctn--show");    
            }
        ...
        <>
            ...
            className="nav-ctn-dsktp">
                ...
                className="search-ctn">
                    ...
                    <PrimBgDiv className={ search.current 
                        ? searchRes 
                    ...
                    className={ user 
                        ...
                        { user 
                            ...
                            <>
                                ...
                                <SecBgDiv 
                                className={`notifs-ctn ${notifs?.length === 0 ? 
                                ...
                                ref={ settingsRef }>
                                    ...
                                    <div 
                                    className="reg-log-btn-ctn__setting-ctn">
                                        <Text>
                                            Theme
                                        </Text>
                            ...
                            : <>
                                ...
                                <Link to="/register" 
                                className="reg-log-btn-ctn__reg-btn" title="Create Account">
                                ...
                                <Link to="/login" 
                                className="reg-log-btn-ctn__log-btn" title="Login">
                    ...
                    { user 
                        ? 
                            <>
                                ...
                                <SecBgDiv 
                                className={`notifs-mob-ctn ${notifs?.length === 0 ? 
                                    "notifs-ctn--no-notifs" : "" }`}
                                ref={ notifsMobRef }>
                                    {
                                        failureState ? 
                                ...
                                <div className="reg-log-btn-ctn__settings-toggle" 
                                onClick={ settingsToggle }
